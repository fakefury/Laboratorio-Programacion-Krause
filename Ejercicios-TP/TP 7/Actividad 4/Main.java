...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Jugador en índice 7: " + jugadores[7].getNombre());
        System.out.println("¿Es titular?: " + jugadores[7].isConvocado());
        System.out.println("Edad de " + jugadores[17].getNombre() + " (Mbappé): " + jugadores[17].getEdad());
    }
}